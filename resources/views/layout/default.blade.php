...
<head>
    ...
    @show
    @section('meta_author')
        <meta name="author" content="@ilyosdev"/>
    @show
    @section('meta_description')
        <meta name="description" content="A transport developed using Laravel 8"/>
    @show
<!-- Mobile Specific Metas
    ...
    {!! app('html')->style('css/bootstrap.theme.min.css') !!}
    {!! app('html')->style('css/noprint.css') !!}
...
<div id="footer">
    <div class="container">
        <div class="muted credit no-print">Developed by <a href="http://appx.uz">Appx Group</a>.</div>
    </div>
</div>
...
{!! app('html')->script('js/jquery.js') !!}
{!! app('html')->script('js/bootstrap.min.js') !!}
{!! app('html')->script('js/delete.js') !!}
