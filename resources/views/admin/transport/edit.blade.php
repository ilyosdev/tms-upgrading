...
@section('content')
    ...
    <div class="form-group">
        {{ Form::select('client_id_edit', App\Models\Client::pluck('name','id'), $transport->client_id, ['class'=>'form-control', 'id'=>'client_id_edit']) }}
    ...
    <div class="form-group ">
        {{ Form::select('vehicle_id_edit', App\Models\Vehicle::pluck('plateNumber','id'), $transport->vehicle_id, ['class'=>'form-control', 'id'=>'vehicle_id_edit']) }}
